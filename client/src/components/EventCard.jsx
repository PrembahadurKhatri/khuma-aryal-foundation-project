      ...
      <div className="flex flex-1 flex-col gap-2.5 p-5">
        ...
        {event.registerLink && (
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="mt-2 inline-flex w-fit items-center gap-1.5 rounded-full bg-forest-700 px-4 py-2 font-body text-xs font-semibold text-white shadow-soft transition-all duration-300 hover:-translate-y-0.5 hover:bg-forest-800 hover:shadow-lift"
          >
            {t("news.register")} →
          </a>
        )}
