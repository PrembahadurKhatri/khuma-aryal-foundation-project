        ...
        <div className="fixed inset-0 z-50 flex items-end justify-center overflow-y-auto bg-black/60 sm:items-center sm:p-4">
          <form onSubmit={handleSubmit} className={`my-0 max-h-[92vh] w-full space-y-3 overflow-y-auto rounded-t-2xl border p-6 sm:my-8 sm:max-w-lg sm:rounded-2xl ${panelClass}`}>
            ...
            <div>
              ...
              <p className={`mt-1 text-xs ${mutedClass}`}>Lets visitors jump from this notice's page to that album's full photo collection under Gallery.</p>
            </div>
            ...
            <div>
              ...
              <input
                ...
                className={inputClass}
              />
              <p className={`mt-1 text-xs ${mutedClass}`}>Shown as a photo gallery on this notice's own detail page. Select more than once to keep adding.</p>
            ...
            <div className="flex flex-col-reverse gap-2 pt-2 sm:flex-row sm:justify-end sm:gap-3">
              ...
              >
                {isSaving && <Spinner />}
                {isSaving ? (editing ? "Saving…" : "Uploading…") : editing ? "Save Changes" : "Create Notice"}
              </button>
            </div>
          </form>
        </div>
